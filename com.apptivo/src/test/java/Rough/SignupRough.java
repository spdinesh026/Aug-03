...
public class SignupRough extends AppBase {
	...
	public void signup() {
		...
		for (int i = 6; i <=6; i++) {
			...
			values("Email_XPATH", "kmn0" + i + "@berijam.com");
			...
			click("Plan_Ultimate_XPATH");
			  ...
			  wait.until(ExpectedConditions
			  .invisibilityOfElementLocated(By.xpath(variables.getProperty(
			  "ProgressBar_XPATH")))); driver.quit();
