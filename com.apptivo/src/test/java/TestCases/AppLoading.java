...
public class AppLoading extends AppBase {
	...
	/*
	 * @Test(priority = 62) public void TestcyclesApp() {
	 * driver.get(config.getProperty("TestcyclesApp"));
	 * ExtentListeners.test.log(Status.INFO, "Navigating to TestcyclesApp"); String
	 * actualresult =
	 * driver.findElement(By.cssSelector(config.getProperty("assertApp"))).getText()
	 * ; String expectedresult = "TEST CYCLES"; Assert.assertEquals(expectedresult,
	 * actualresult); }
	 */
